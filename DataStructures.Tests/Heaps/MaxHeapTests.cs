...
namespace DataStructures.Tests.Heaps {
    ...
    public class MaxHeapTests {
        ...
        [TestMethod]
        public void Add_MultipleElements_ShouldKeepMaxAtRoot() {
            var heap = new MaxHeap<int>();
            heap.Add(5);
            heap.Add(10);
            heap.Add(3);
        ...
        [TestMethod]
        public void Pop_ShouldRemoveAndReturnMax() {
            var heap = new MaxHeap<int>();
            heap.Add(5);
            heap.Add(10);
            heap.Add(3);
        ...
        [TestMethod]
        public void Pop_UntilEmpty_ShouldReturnElementsInDescendingOrder() {
            var heap = new MaxHeap<int>();
        ...
        [TestMethod]
        public void Peek_ShouldReturnMaxWithoutRemoving() {
            var heap = new MaxHeap<int>();
            heap.Add(5);
            heap.Add(10);
            heap.Add(3);
        ...
        public void CopyTo_WithOffset_ShouldCopyToCorrectPosition() {
            ...
            Assert.IsTrue(array[2] == 10 || array[2] == 5 || array[2] == 3);
            Assert.IsTrue(array[3] == 10 || array[3] == 5 || array[3] == 3);
            Assert.IsTrue(array[4] == 10 || array[4] == 5 || array[4] == 3);
        }
